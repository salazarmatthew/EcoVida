...
import com.salazar.authservice.dtos.*;
import com.salazar.authservice.exceptions.*;
import com.salazar.authservice.dtos.*;
import com.salazar.authservice.exceptions.*;
import com.salazar.authservice.factories.RoleFactory;
import com.salazar.authservice.feigns.NotificationService;
import com.salazar.authservice.modals.Role;
import com.salazar.authservice.modals.User;
import com.salazar.authservice.repositories.UserRepository;
import com.salazar.authservice.security.UserDetailsImpl;
import com.salazar.authservice.security.jwt.JwtUtils;
...
public class AuthServiceImpl implements AuthService {
    ...
    private void sendRegistrationVerificationEmail(User user) {
        ...
        String content = "Estimado " + user.getUsername() + ",<br><br>"
                + "<p>¡Gracias por unirte a nosotros! Estamos encantados de tenerte a bordo.</p><br>"
                + "<p>Para completar el proceso de registro, ingresa el código de verificación en tu dispositivo.</p><br>"
                + "<p>Código de verificación: <strong>" + user.getVerificationCode() + "</strong></p><br>"
                + "<p><strong>Ten en cuenta que el código de verificación anterior expirará en 15 minutos.</strong></p>"
                + "<br>Gracias,<br>"
                + "EcoVida.";
